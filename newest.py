...
if __name__ == '__main__':
    ...
    starting_items={lights[0]:[rooms[0],0],lights[1]:[rooms[1],0]}
    goal_items = copy.deepcopy(starting_items)
    goal_items[lights[0]][1] = 1
    goal_items[lights[1]][1] = 1
    print ACTIONS
    policy = get_l1_policy(rooms[0], rooms[1], starting_items=starting_items, goal_items=goal_items,actions=ACTIONS, doors=doors,rooms=rooms)
