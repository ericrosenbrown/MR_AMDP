...
if __name__ == '__main__':
    ...
    start_room = rooms[0]
    goal_room = rooms[3]
    policy = get_l1_policy(start_room=start_room, goal_room=goal_room, starting_items=starting_items, goal_items=goal_items,actions=ACTIONS, doors=doors,rooms=rooms)
