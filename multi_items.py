...
class FourRoomL1MDP(MDP):
    ...
    def __init__(self, starting_room=1, goal_room=4, starting_items=[], goal_items=[] ,gamma=0.99):
...
def get_l1_policy(start_room=None, goal_room=None, mdp=None, starting_items=None, goal_items=None):
    if mdp is None:
        mdp = FourRoomL1MDP(start_room, goal_room,starting_items=starting_items,goal_items=goal_items) #room 2, light off =0, light on =1
...
if __name__ == '__main__':
    policy = get_l1_policy(1, 5, starting_items=[0,0], goal_items=[1,1])
